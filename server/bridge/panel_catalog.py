...
PANELS: list[dict[str, Any]] = [
  ...
  },
  {
    ...
    "widgets": [{"type": "bool", "param": "AmapMapDataEnabled", "label": "Enable Amap Map Data", "offroad_only": True,
       ...
       "desc": "API key for Amap services. Tap EDIT to enter or update the key."},{"type": "separator"},{"type": "multiple_button", "param": "CarrotPanelSide", "label": "Carrot Nav Panel Side",
       "offroad_only": True,
       "buttons": ["Left", "Right"],
