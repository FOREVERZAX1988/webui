...
PANELS: list[dict[str, Any]] = [
  ...
  },
  {
    ...
    "widgets": [{"type": "bool", "param": "AmapMapDataEnabled", "label": "Enable Amap Map Data", "offroad_only": True,
       "desc": "Use Amap (Gaode) online map data for speed limits and road names in China."},{"type": "bool", "param": "CarrotAmapBlindSpotEnabled", "label": "Enable Amap Blind Spot Data", "offroad_only": True,
       ...
       "visible_if": {"param": "AmapMapDataEnabled", "eq": "1"},
       "desc": "Show how many traffic lights are on the route ahead. Display only; it never controls the car."},{"type": "separator"},{"type": "multiple_button", "param": "CarrotPanelSide", "label": "Carrot Nav Panel Side",
       "offroad_only": True,
       "buttons": ["Left", "Right"],
       "desc": "Place the onroad Carrot navigation panel on the left or right side of the screen."},{"type": "int", "param": "CarrotPanelOpacity", "label": "Carrot Nav Panel Opacity",
       ...
       "desc": "View the last navigation event summary handled by CarrotManager."},{"type": "separator"},{"type": "bool", "param": "CarrotNavCruiseSpeedEnabled", "label": "Navigation Cruise Speed", "default": True,
       "visible_if": {"param": "CarrotEnabled", "eq": "1"},
